...
// const position = 2;
// let medal = "pat on the back"; // ji yra kintanti, del to jos nekeiciam
...
if (peopleCount === 4) {
    ...
    musicalGroup = "didelė grupė.";
}

console.log(group + " " + peopleCount + " " + "yra " + musicalGroup);